...
import { Avatar, styled, useTheme, Typography, Box } from "@mui/material";
...
export default function MiniDrawer({ open, handleDrawerClose }) {
  ...
  return (
    <Drawer variant="permanent" open={open}>
      ...
      <Box sx={{ my: 2 }}>
        <Avatar sx={{ mx: "auto", width: open? 80 : 45, height: open? 80 : 45, mb:1, border: "2px solid gray", transition: "0.25s" }} alt="Cindy Baker" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_vN_ANOiFu84OseD9ywZ8jLvlKhu5Ee6CBg&s" />
        <Typography align="center" sx={{fontSize: open ? 18 : 0, transition: "0.25s"}} > Cindy </Typography>
